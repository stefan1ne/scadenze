...
const App = () => {
  ...
  const fetchTasks = async () => {
    const res = await fetch('https://scadenze.netlify.app:5000/tasks')
  ...
  const fetchTask = async (id) => {
    const res = await fetch(`https://scadenze.netlify.app:5000/tasks/${id}`)
    const data = await res.json()
    return data
  }
  ...
  const addTask = async (task) => {
    const res = await fetch('https://scadenze.netlify.app/tasks', {
      method: 'POST',
      headers: {
  ...
  const deleteTask = async (id) => {
    const res = await fetch(`https://scadenze.netlify.app/tasks/${id}`, {
      method: 'DELETE',
    })
